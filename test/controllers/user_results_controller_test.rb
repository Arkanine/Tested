...
class UserResultsControllerTest < ActionController::TestCase
  ...
  test "should create user_result" do
    assert_difference('UserResult.count') do
      post :create, user_result: { score: @user_result.score, test_id: @user_result.test_id, user_id: @user_result.user_id }
    end
  ...
  test "should update user_result" do
    patch :update, id: @user_result, user_result: { score: @user_result.score, test_id: @user_result.test_id, user_id: @user_result.user_id }
    assert_redirected_to user_result_path(assigns(:user_result))
  end
